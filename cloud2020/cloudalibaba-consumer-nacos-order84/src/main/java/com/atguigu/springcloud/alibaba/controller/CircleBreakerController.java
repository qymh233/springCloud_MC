...
public class CircleBreakerController {
    ...
    //@SentinelResource(value = "fallback",blockHandler = "blockHandler")//blockHandler只负责seninel控制台配置违规
    ...
    public CommonResult<Payment> blockHandler(@PathVariable Long id, BlockException blockException){
        Payment payment=new Payment(id,"null");
        return new CommonResult<>(445,"handlerFallback-sentinel限流，无此流水: blockException: "+blockException.getMessage(),payment);
    }
